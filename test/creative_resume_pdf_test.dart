...
void main() {
  ...
  setUpAll(() async {
    ...
    hiveDir = await Directory.systemTemp.createTemp('resume-app-creative-pdf');
  ...
  test('generates creative resume pdf with profile arrow bullets', () async {
    final now = DateTime(2026, 4, 7);
    final resume = ResumeModel(
      id: 'creative-resume-pdf-test',
    ...
    final template = PdfTemplateFactory.getTemplate('creative');
