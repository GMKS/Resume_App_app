...
void main() {
  ...
  setUpAll(() async {
    ...
    hiveDir = await Directory.systemTemp.createTemp('resume-app-modern-nova');
  ...
  test('generates modern nova pdf with aligned header and section content',
      () async {
    final now = DateTime(2026, 4, 7);
    final resume = ResumeModel(
      id: 'modern-nova-pdf-test',
      title: 'Modern Nova Resume',
    ...
    final template = PdfTemplateFactory.getTemplate('modern');
  ...
  test('generates modern nova pdf for imported experience without end date',
      () async {
    final now = DateTime(2026, 4, 22);
    final resume = ResumeModel(
      id: 'modern-nova-linkedin-import-test',
      title: 'LinkedIn Imported Resume',
      personalInfo: PersonalInfo(
        fullName: 'LinkedIn Import User',
      ...
      objective:
          'Imported from LinkedIn profile text to verify preview generation stays stable.',
      experience: [
        Experience(
          id: 'exp-import-1',
          company: 'Acme Corp',
          ...
          description:
              'Imported experience that does not include a parsed end date.',
          location: 'Remote',
        ),
      ],
      education: [],
      skills: [
        Skill(id: 'skill-import-1', name: 'Flutter'),
      ],
      projects: [],
      certifications: [],
      languages: [
        Language(id: 'lang-import-1', name: 'English', proficiency: 'Fluent'),
      ],
      templateId: 'modern',
      createdAt: now,
      updatedAt: now,
