                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        section('CONTACT'),
                        if (phone.isNotEmpty) _iconRow(Icons.phone, phone),
                        if (email.isNotEmpty) _iconRow(Icons.email, email),
                        if (linkedIn.isNotEmpty) _iconRow(Icons.link, linkedIn),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (work.isNotEmpty) ...[
                                ...
                                ...work.map((w) {
                                  final role = (w['jobTitle'] ?? '').toString();
                                  final company = (w['company'] ?? '')
                                      .toString();
                                  final city = (w['location'] ?? '').toString();
