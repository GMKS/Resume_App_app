...
import 'two_page_resume_form_screen.dart';
...
class _ResumeTemplateSelectionScreenState
  ...
  final templates = <_TemplateMeta>[
    ...
    _TemplateMeta(
      ...
      bestFor: 'Detailed',
      style: 'AI-powered document import',
      requiredFields: const ['Name', 'Contact', 'Experience'],
      screen: const TwoPageResumeFormScreen(),
      prefix: 'twopage',
    ),
  ];
