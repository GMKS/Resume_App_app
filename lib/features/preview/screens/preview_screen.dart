...
class _PreviewScreenState extends ConsumerState<PreviewScreen> {
  ...
  static const double _readingTopGap = 12;
  static const double _readingSideGap = 4;
  static const double _readingBottomGap = 8;
  ResumeModel? _resume;
  ...
  Widget _buildRasterPreview() {
    return ListView.separated(
      padding: EdgeInsets.fromLTRB(
        _isReadingMode ? _readingSideGap : 16,
        0,
        _isReadingMode ? _readingSideGap : 16,
        _isReadingMode ? _readingBottomGap : 24,
      ),
  ...
  Widget _wrapPreviewWithReadingZoom(Widget child) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final safeTopInset = safePadding.top + _readingTopGap;
        ...
        return SingleChildScrollView(
          ...
          child: ConstrainedBox(
            ...
            child: Padding(
              padding: EdgeInsets.only(top: safeTopInset),
              child: Align(
