...
class ClassicResumeTemplatePreview extends StatelessWidget {
  const ClassicResumeTemplatePreview({
    super.key,
  ...
  List<_ClassicPreviewContactItem> get _contactItems {
    final info = resume?.personalInfo;
    final items = <_ClassicPreviewContactItem>[];

    void add(IconData icon, String? value) {
      final trimmed = value?.trim() ?? '';
      if (trimmed.isNotEmpty) {
        items.add(_ClassicPreviewContactItem(icon: icon, label: trimmed));
      }
    }
  ...
  List<_ClassicPreviewExperience> get _experiences {
    final values = resume?.experience ?? const <Experience>[];
    if (values.isEmpty) {
      return const [
        _ClassicPreviewExperience(
    ...
    return values.take(2).map((experience) {
      ...
      return _ClassicPreviewExperience(
  ...
  _ClassicPreviewEducation get _education {
    final values = resume?.education ?? const <Education>[];
    if (values.isEmpty) {
      return const _ClassicPreviewEducation(
    ...
    return _ClassicPreviewEducation(
  ...
  List<_ClassicPreviewProject> get _projects {
  ...
  Widget _headerContactItem(_ClassicPreviewContactItem item) {
    return SizedBox(
      height: 10,
      child: Row(
        children: [
  ...
  List<List<_ClassicPreviewContactItem>> get _headerContactRows {
    if (_contactItems.isEmpty) {
      return const [];
    }

    final rows = <List<_ClassicPreviewContactItem>>[];
  ...
  Widget _experienceBlock(_ClassicPreviewExperience experience) {
  ...
  Widget _projectBlock(_ClassicPreviewProject project) {
    return Padding(
...
class _ClassicPreviewContactItem {
  const _ClassicPreviewContactItem({required this.icon, required this.label});

  final IconData icon;
  final String label;
}

class _ClassicPreviewExperience {
  const _ClassicPreviewExperience({
    required this.title,
...
class _ClassicPreviewEducation {
  const _ClassicPreviewEducation({
...
class _ClassicPreviewProject {
  const _ClassicPreviewProject(
