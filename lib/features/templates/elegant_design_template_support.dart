...
class ElegantDesignContactItem {
  const ElegantDesignContactItem({
    required this.kind,
    required this.label,
  });

  final ElegantDesignContactKind kind;
  final String label;
}

class ElegantDesignEducationEntry {
  const ElegantDesignEducationEntry({
...
class ElegantDesignExperienceEntry {
  const ElegantDesignExperienceEntry({
    required this.title,
...
class ElegantDesignProjectEntry {
  const ElegantDesignProjectEntry({
    required this.title,
    this.detailLines = const <String>[],
    this.technologyLine = '',
...
class ElegantDesignCertificationEntry {
  const ElegantDesignCertificationEntry({
    required this.name,
    this.detailLines = const <String>[],
    this.links = const <String>[],
  });
...
class ElegantDesignReferenceEntry {
  const ElegantDesignReferenceEntry({
    required this.name,
    this.roleLine = '',
    this.contactLine = '',
  });
...
class ElegantDesignTemplateSupport {
  static const int pageHex = 0xFFF3F0EC;
  static const int sheetHex = 0xFFF9F6F2;
  static const int sidebarHex = 0xFFE7E2DE;
  static const int lineHex = 0xFFD7C4B1;
  static const int headingHex = 0xFF4B5870;
  static const int accentHex = 0xFFC9935B;
  static const int inkHex = 0xFF48546D;
  static const int mutedHex = 0xFF736B63;
  static const int sidebarTextHex = 0xFF665F59;
  static const int avatarFillHex = 0xFFF3EEE9;
  ...
  static List<ElegantDesignContactItem> contactItems(
    PersonalInfo? info, {
    bool compactLinks = true,
    bool includeAddress = false,
  }) {
    final items = <ElegantDesignContactItem>[];
    final seen = <String>{};

    void add(ElegantDesignContactKind kind, String? value) {
      ...
      items.add(ElegantDesignContactItem(kind: kind, label: label));
    }

    add(ElegantDesignContactKind.phone, info?.phone);
    add(ElegantDesignContactKind.email, info?.email);
    if (includeAddress) {
      add(ElegantDesignContactKind.address, info?.address);
    }
    add(ElegantDesignContactKind.linkedin, info?.linkedIn);
    add(ElegantDesignContactKind.github, info?.github);
    add(ElegantDesignContactKind.website, info?.website);
  ...
  static List<ElegantDesignEducationEntry> educationEntries(
    ...
    final entries = educations.map((education) {
      ...
      return ElegantDesignEducationEntry(
  ...
  static List<ElegantDesignExperienceEntry> experienceEntries(
    ...
    final entries = experiences.map((experience) {
      ...
      return ElegantDesignExperienceEntry(
  ...
  static List<ElegantDesignProjectEntry> projectEntries(
    ...
    final entries = projects.map((project) {
      ...
      return ElegantDesignProjectEntry(
        title:
  ...
  static List<ElegantDesignCertificationEntry> certificationEntries(
    ...
    final entries = certifications.map((certification) {
      ...
      return ElegantDesignCertificationEntry(
  ...
  static List<ElegantDesignReferenceEntry> referenceEntries(
    ...
    final entries = references
        .map((reference) {
          ...
          return ElegantDesignReferenceEntry(
            name: name,
            roleLine: roleLine,
            contactLine: contactLine,
          );
        })
        .whereType<ElegantDesignReferenceEntry>()
        .toList(growable: false);
