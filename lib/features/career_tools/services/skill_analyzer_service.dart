...
class SkillAnalyzerService {
  ...
  Future<void> persistUserSkills(List<AnalyzedSkill> skills) async {
    final payload =
        skills.map((skill) => skill.toMap()).toList(growable: false);
    ...
    // Best-effort backend persistence. Local storage remains the source of truth.
...
final skillAnalyzerControllerProvider =
    StateNotifierProvider<SkillAnalyzerController, SkillAnalyzerState>((ref) {
